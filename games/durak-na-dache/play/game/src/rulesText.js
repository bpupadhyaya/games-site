...
// comfortable size at every text-size step (view.js's drawReferencePage()) without ever overflowing the
// panel — several pages below are split from what used to be one denser page for exactly that reason.
export const RULES = [
  {
    title: 'The deck',
    cards: [
  ...
  },
  {
    ...
    lines: [
      ...
      'Perevodnoy ("transfer"), which adds one extra option, covered next. Podkidnoy has no transfer at',
      'all — there the defender may only beat or take.',
    ],
  },
  {
  ...
  },
  {
    ...
    lines: [
      ...
      'on the table, and it cannot push the table past the round\'s cap (covered earlier). After a transfer,',
