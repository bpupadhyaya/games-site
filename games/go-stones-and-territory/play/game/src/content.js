...
//
// Pages are kept short - one or two paragraphs, a single concept - so every page still fits inside
// the reader panel at the top text-size step (see layout.js's TEXT_SCALES). Several of the original
// longer, 3-4 paragraph pages were split in two for exactly this reason; the wording is unchanged,
// only regrouped onto more pages.
...
export const RULES = [
  ...
  {
    title: 'Star points, and who plays first',
    lines: [
  ...
  {
    title: 'The suicide rule: check order',
    lines: [
  ...
  {
    title: 'Ko: how long the ban lasts',
    lines: [
  ...
  {
    title: 'Positional superko: the computer\'s own search',
    lines: [
  ...
  {
    title: 'Scoring: komi and winning',
    lines: [
