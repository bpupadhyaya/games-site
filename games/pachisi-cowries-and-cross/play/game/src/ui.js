...
// build with a shorter/longer array is easy to clamp (see game.js prefs load).
...
export function screenButtons(s) {
  ...
  if (sc === 'title') {
    ...
    B.push(
      ...
      { id: 'back', ...row(2, 0), y: 1310, h: 70, label: 'Back' }, { id: 'page', ...row(2, 1), y: 1310, h: 70, label: 'Next page', primary: true },
    );
