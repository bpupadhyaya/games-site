...
export const HOWTO = [{ blocks: [
  { h: 'Controls', p: 'TAP the dice to roll. TAP one of your checkers: the points it can reach glow. TAP a glowing point to move there, or DRAG the checker and drop it on a glowing point. TAP Undo to take back a move in your turn. On a keyboard: Space rolls, Left and Right choose, Enter moves, U undoes.' },
...
export const RULES = [
  ...
  { title: 'The bar and entering', blocks: [
  ...
  { title: 'The doubling cube', blocks: [
  ...
  { title: 'Winning and scoring', blocks: [
