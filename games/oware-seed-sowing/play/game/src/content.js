...
//
// Each page here holds at most one or two short paragraphs. At the top text-size step (layout.js
// TEXT_SCALES) a page's wrapped lines can run noticeably taller than before, so topics that used to
// be one page (four or five paragraphs) are now split into several shorter, single-concept pages -
// verified by actually rendering every page at the top step (see the game's STATUS.md).
export const RULES = [
  {
    title: 'The board',
    role: 'setup',
